    ...
    Eigen::Matrix2d * pointJacobian, Eigen::Matrix2Xd * parameterJacobian) const
{
  ...
  J(0, 0) = p1_ * u1 * 2.0 + p2_ * u0 * 6.0
            ...
            + (u0
               * (rho_u * (u0 * (k2_ + k3_ * rho_u) * 2.0 + k3_ * u0 * rho_u * 2.0)
  ...
  J(0, 1) = p1_ * u0 * 2.0 + p2_ * u1 * 2.0
            + (u0
               * (rho_u * (u1 * (k2_ + k3_ * rho_u) * 2.0 + k3_ * u1 * rho_u * 2.0)
  ...
  const double u0 = pointUndistorted[0];
    ...
    const double rad_dist_u = (1.0 + ((k3 * rho_u + k2) * rho_u + k1) * rho_u)
      ...
      J(0, 0) = p1 * u1 * 2.0 + p2 * u0 * 6.0
                ...
                + (u0
                   * (rho_u * (u0 * (k2 + k3 * rho_u) * 2.0 + k3 * u0 * rho_u * 2.0)
      ...
      J(0, 1) = p1 * u0 * 2.0 + p2 * u1 * 2.0
                + (u0
                   * (rho_u * (u1 * (k2 + k3 * rho_u) * 2.0 + k3 * u1 * rho_u * 2.0)

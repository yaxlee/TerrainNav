...
#ifndef INCLUDE_DGVI_CAMERAS_PINHOLECAMERA_HPP_
#define INCLUDE_DGVI_CAMERAS_PINHOLECAMERA_HPP_
...
/// \tparam DISTORTION_T the distortion type, e.g. dgvi::cameras::RadialTangentialDistortion
...
#endif /* INCLUDE_DGVI_CAMERAS_PINHOLECAMERA_HPP_ */

...
#ifndef INCLUDE_DGVI_NCAMERASYSTEM_HPP_
#define INCLUDE_DGVI_NCAMERASYSTEM_HPP_
...
class NCameraSystem
{
 public:
  ...
  enum DistortionType  {
    Equidistant = 0, ///< Use with dgvi::cameras::EquidistantDistortion.
    RadialTangential = 1, ///< Use with dgvi::cameras::RadialTangentialDistortion.
    NoDistortion = 2, ///< No distortion.
    RadialTangential8 = 3 ///< Use with dgvi::cameras::RadialTangentialDistortion.
  };
  ...
  struct CameraType {
    ...
    bool isUsed = true; ///< Set false if not in use for dgvi.
  ...
  inline void addCamera(std::shared_ptr<const dgvi::kinematics::Transformation> T_SC,
  ...
  inline std::shared_ptr<const dgvi::kinematics::Transformation> T_SC(size_t cameraIndex) const;
  ...
  inline std::shared_ptr<const dgvi::kinematics::Transformation> rectifyT_SC(size_t cameraIndex) const;
 ...
 protected:
  ...
  std::vector<std::shared_ptr<const dgvi::kinematics::Transformation>> T_SC_; ///< IMU-cam trafo.
  ...
  std::vector<std::shared_ptr<const dgvi::kinematics::Transformation>> virtual_T_SC_; ///< IMU-cam trafo.
  ...
  std::map<size_t, std::shared_ptr<const dgvi::kinematics::Transformation>> rectify_T_SC_; ///< IMU-cam(rectify) trafo.
...
#endif /* INCLUDE_DGVI_NCAMERASYSTEM_HPP_ */

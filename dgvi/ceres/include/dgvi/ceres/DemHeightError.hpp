...
#ifndef INCLUDE_DGVI_CERES_DEMHEIGHTERROR_HPP_
#define INCLUDE_DGVI_CERES_DEMHEIGHTERROR_HPP_
...
class DemHeightError
 ...
 public:
  ...
  DemHeightError(double h_sensor,
                 ...
                 const dgvi::kinematics::Transformation& T_GW)
      : h_sensor_(h_sensor),
        sigma_h_(sigma_h),
        r_SA_(r_SA),
        C_GW_(T_GW.C()),
...
#endif  // INCLUDE_DGVI_CERES_DEMHEIGHTERROR_HPP_

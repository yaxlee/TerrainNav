...
#ifndef INCLUDE_DGVI_CERES_PARAMETERBLOCK_HPP_
#define INCLUDE_DGVI_CERES_PARAMETERBLOCK_HPP_
...
class ParameterBlock {
 public:
  ...
  /// \brief Computes the minimal diff. between a variable x and a perturbed variable x_plus_delta.
  /// @param[in] x0 Variable.
  ...
  /// \brief Computes Jacobian from minimal space to naively overparametr. space as used by ceres.
  /// @param[in] x0 Variable.
...
#endif /* INCLUDE_DGVI_CERES_PARAMETERBLOCK_HPP_ */

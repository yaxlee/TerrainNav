...
#ifndef INCLUDE_DGVI_OPENGV_FRAMERELATIVEADAPTER_HPP_
#define INCLUDE_DGVI_OPENGV_FRAMERELATIVEADAPTER_HPP_
...
#endif /* INCLUDE_DGVI_OPENGV_FRAMERELATIVEADAPTER_HPP_ */

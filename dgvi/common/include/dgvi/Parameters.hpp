...
#ifndef INCLUDE_DGVI_PARAMETERS_HPP_
#define INCLUDE_DGVI_PARAMETERS_HPP_
...
struct ImuParameters{
  ...
  dgvi::kinematics::Transformation T_BS; ///< Transform from Body frame to IMU (sensor frame S).
...
struct LidarParameters {
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    dgvi::kinematics::Transformation T_SL;   ///< Transformation from LiDAR to sensor (IMU) frame.
...
struct ViParameters {
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  dgvi::cameras::NCameraSystem nCameraSystem;  ///< Camera extrinsics and intrinsics.
...
#endif // INCLUDE_DGVI_PARAMETERS_HPP_

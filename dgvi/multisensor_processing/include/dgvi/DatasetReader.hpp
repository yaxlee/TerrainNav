...
#ifndef INCLUDE_DGVI_DATASETREADER_HPP_
#define INCLUDE_DGVI_DATASETREADER_HPP_
...
private:
  ...
  dgvi::Time t_gps_; ///< Timestamp of the last gps signal received
...
#endif // INCLUDE_DGVI_DATASETREADER_HPP_
